...
const galleryImages = [
  {
    ...
    category: "Commercial",
    description: "The landmark façade featuring sustainable materials and energy-efficient design.",
    image: "https://images.unsplash.com/photo-1599809275671-b5942cabc7a2?w=1200&h=800",
  },
  {
    id: 2,
    title: "Oceanfront Residence - Living Space",
    category: "Residential",
    description: "Open-concept living area with panoramic views of the Pacific Ocean.",
    image: "https://images.unsplash.com/photo-1600596542815-ffad4c1539a9?w=1200&h=800",
  },
  {
    id: 3,
    title: "The Vertex - Central Atrium",
    category: "Commercial",
    description: "Multi-story atrium with natural light and collaborative work areas.",
    image: "https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1200&h=800",
  },
  {
    id: 4,
    title: "Echo Library - Reading Hall",
    category: "Institutional",
    description: "The main reading hall with its distinctive curved ceiling and acoustic design.",
    image: "https://images.unsplash.com/photo-1541123437800-1bb1317badc2?w=1200&h=800",
  },
  {
    id: 5,
    title: "Harmony Pavilion - Event Space",
    category: "Cultural",
    description: "Configurable event space with advanced lighting and sound systems.",
    image: "https://images.unsplash.com/photo-1477959858617-67f85cf4f1df?w=1200&h=800",
  },
  {
    id: 6,
    title: "The Prism House - Interior",
    category: "Residential",
    description: "Living room with geometric light patterns created by the prismatic exterior.",
    image: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=1200&h=800",
  },
];
      ...
      <div className="container mx-auto px-4 relative">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Explore our architectural projects through this curated collection of images. 
        ...
        >
          {galleryImages.map((image) => (
            <Dialog key={image.id} open={openDialog && selectedImage === image.id} onOpenChange={(open) => {
              setOpenDialog(open);
                ...
                >
                  ...
                  <div className="aspect-[4/3] relative">
                    ...
                    <div className="absolute bottom-0 left-0 p-4 z-10">
                      <span className="text-white/70 text-xs uppercase tracking-widest">{image.category}</span>
                      <h3 className="text-lg font-bold text-white group-hover:text-white mt-1">{image.title}</h3>
        ...
        >
          <div className="mb-8 text-center">
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80 inline-block">Featured Project Highlights</h3>
                  ...
                  <Dialog onOpenChange={(open) => {
                    ...
                    <DialogTrigger asChild>
                      ...
                      >
                        ...
                        {/* Text content */}
                        <div className="absolute bottom-0 left-0 p-4 z-10">
                          <h4 className="text-base font-bold text-white truncate">{image.title}</h4>
