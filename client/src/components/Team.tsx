...
const teamMembers = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&h=256&q=80",
    socialLinks: {
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-gray-400 max-w-2xl mx-auto">
            Our talented team of architects and designers brings diverse expertise and passion to every project.
          </p>
        </motion.div>
            ...
            >
              <Card className="bg-gray-900/50 border-gray-800 overflow-hidden hover:border-primary/50 transition-all duration-300">
                <div className="relative aspect-square overflow-hidden">
                  ...
                  >
                    <a href={`mailto:${member.socialLinks.email}`} className="bg-gray-900/80 p-2 rounded-full hover:bg-primary/90 transition-colors">
                      <Mail className="h-5 w-5" />
                    </a>
                    <a href={member.socialLinks.linkedin} className="bg-gray-900/80 p-2 rounded-full hover:bg-[#0077B5]/90 transition-colors">
                      <Linkedin className="h-5 w-5" />
                    </a>
                    <a href={member.socialLinks.twitter} className="bg-gray-900/80 p-2 rounded-full hover:bg-[#1DA1F2]/90 transition-colors">
