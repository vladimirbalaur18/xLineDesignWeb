        ...
        >
          ...
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            ...
            <a
              ...
              className="group flex flex-col items-center gap-2 focus:outline-none"
            >
              <span className="flex items-center justify-center w-14 h-14 rounded-full bg-white/10 group-hover:bg-[#1da1f2] group-hover:shadow-[0_0_0_4px_rgba(29,161,242,0.15)] transition-all duration-200">
                <svg
                  width="32"
                  height="32"
                  fill="currentColor"
              ...
              <span className="text-xs font-medium group-hover:text-[#1da1f2] transition-colors">
                Twitter
              </span>
            </a>
            <a
