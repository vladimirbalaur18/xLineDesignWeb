    ...
    return (
      <div
        ...
        style={{
          transform: isHovered
            ? `translateX(${
                mousePosition.x * depthFactor * -0.5
              }px) translateY(${mousePosition.y * depthFactor * -0.5}px)`
            : "none",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-8 z-10">
        ...
        >
          Innovative{" "}
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-white via-white/80 to-white">
            Design
          </span>
        </motion.h2>
        <motion.div
        ...
        <motion.p
          ...
          viewport={{ once: true }}
        >
          Interactive 3D visualization that responds to your movement, allowing
          you to explore architectural concepts from multiple perspectives
        </motion.p>
      </div>
