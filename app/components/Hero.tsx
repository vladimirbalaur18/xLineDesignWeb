        ...
        <AnimatePresence>
          ...
          >
            <div className="w-64 h-64 relative">
              ...
              <div
                className="absolute inset-0 border border-white/20 backdrop-blur-sm bg-black/20 
          ...
          style={{
            ...
            transform: cursorActive
              ? `rotateY(${(mousePosition.x - window.innerWidth / 2) / 60}deg) 
                 rotateX(${
                   -(mousePosition.y - window.innerHeight / 2) / 60
                 }deg)`
              : "none",
            transformStyle: "preserve-3d",
          }}
        ...
        >
          <h1 className="mb-10">
            <div className="text-4xl md:text-5xl lg:text-7xl font-bold tracking-tighter uppercase relative mb-4 backdrop-blur-sm py-2">
              ...
              <motion.span
                className="relative l-10 z-10 inline-block bg-clip-text text-transparent bg-gradient-to-r from-white/80 to-white/60"
                initial={{ opacity: 0, x: 20 }}
                animate={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <motion.p
              className="text-md md:text-2xl font-light tracking-wide px-6 py-4 bg-gradient-to-b from-white to-gray-400 bg-clip-text text-transparent"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
